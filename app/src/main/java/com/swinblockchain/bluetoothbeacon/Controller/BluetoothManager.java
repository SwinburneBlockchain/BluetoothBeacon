...
import com.swinblockchain.bluetoothbeacon.Model.Constants;
...
public class BluetoothManager {
    ...
    private static final String NAME_SECURE = "BluetoothBeaconSecure";
    private static final String NAME_INSECURE = "BluetoothBeaconInsecure";
